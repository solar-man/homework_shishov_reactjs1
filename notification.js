function notifications(window) {
    ...
    function changePushStatus(status) {
        ...
        if (status) {
            ...
            pushImgElement.src = '/src/img/notifications_off.png';
        } else {
            pushElement.classList.remove('active');
            pushImgElement.src = '/src/img/notifications_on.png';
        }
    }
...
// Ненадёжное решение,
// которое позволяет дождаться отрисовки страницы,
// прежде чем выполнить скрипт
setTimeout(function () {
